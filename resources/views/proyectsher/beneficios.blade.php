  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="{{ route('hercules.storebenef') }}" method = "POST">
           {{ csrf_field() }}
      <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="beneficio" name="beneficio" required maxlength="9">
          </div>
...
<div class="modal-content">
   ...
   <form class="container" action="{{ route('hercules.updatebenef') }}" method = "post">
     {{ csrf_field() }}
     ...
     <input type="hidden" id="id" name="id">
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" id="benef" placeholder="Beneficio Economico" name="benef" required maxlength="9">
          </div>
      </div>
...
<div class="modal-dialog">
  <div class="modal-content">
     ...
     <form class="container" action="{{ route('hercules.destroybenef') }}  " method="POST">
     {{ csrf_field() }}
