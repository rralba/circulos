...
<br>
<h1 align="center">Proyectos Activos, Nivel 1 y 2 MIMOSA</h1>
<br>
<br>
            ...
            @foreach($proyects as $proyect)
                <tr>
                    ...
                    <td>{{ $proyect->comite }}</td>
                        @can('filial.index')
                        <td width="07px">
                            <a  href="{{ route('mimosa.show', $proyect->id) }}"
                        ...
                        @can('filial.index')
                            <td width="07px">
                                <a href="{{ route('mimosa.edit', $proyect->id) }}"
    ...
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('mimosa.store') }}" method = "POST">
                {{ csrf_field() }}
