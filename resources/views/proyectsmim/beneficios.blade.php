  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="{{ route('mimosa.storebenef') }}" method = "POST">
           {{ csrf_field() }}
...
<div class="modal-content">
   ...
   <form class="container" action="{{ route('mimosa.updatebenef') }}" method = "post">
     {{ csrf_field() }}
...
<div class="modal-dialog">
  <div class="modal-content">
     ...
     <form class="container" action="{{ route('mimosa.destroybenef') }}  " method="POST">
     {{ csrf_field() }}
